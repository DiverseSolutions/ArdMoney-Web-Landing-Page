      ...
      <div class="flex font-roboto justify-center w-full">
        <div class="py-12 flex flex-col sm:flex-row rounded-lg w-11/12 2xl:w-9/12 bg-primary-mini">
          ...
          <div class="px-8 text-center sm:text-left sm:pl-20 basis-10/12 flex flex-col justify-around order-2 sm:order-1">
            ...
            <p class="text-md sm:text-2xl md:text-lg my-5 sm:m-0 text-gray-400">АрдМааний токен эзэмшигчид болон протоколын хэрэглэгчидтэй нэгдэж, Веб 3.0 хувьслын хурдасгуур бол!</p>
            ...
            <div class="flex flex-wrap sm:flex-nowrap justify-center sm:justify-start">
              ...
              <a href="https://twitter.com/AxxmLabs" class="inline-block md:ml-4 w-52 sm:w-auto sm:px-12 justify-center py-3 rounded-lg flex text-xl community-button-linear-bg items-center">
